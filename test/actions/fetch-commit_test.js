...
describe('fetchCommit', () => {
  it('should request GitHub API successfully', () => {
    ...
    return shouldFulfilled(fetchCommit(DUMMY_SHA)(dispatch, () => {
    })).then(() => {
      scope.done()
  ...
  it('should fail by failed to request GitHub API (404)', () => {
    ...
    return shouldRejected(fetchCommit(dummySHA)(dispatch, () => {
    })).catch(() => {
      scope.done()
  ...
  it('should fail by failed to request GitHub API (401)', () => {
    ...
    return shouldRejected(fetchCommit(DUMMY_SHA)(dispatch, () => {
    })).catch(() => {
      scope.done()
